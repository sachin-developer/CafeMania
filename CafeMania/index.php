    ...
    <div class="container">
      ...
      <div class="navbar-header">
	   <div class="pull-left logo">
        <a class="" href="#home"><img src="./public/img/logo.png" /></a>
       </div>
...
<div id="about" name="about">
  <div class="container">
    <div class="row white">
      ...
      <hr>
      <div class="col-md-6"> <img class="img-responsive" src="./public/img/about/about1.jpg" align=""> </div>
      <div class="col-md-6">
        <h3>Who we are</h3>
  ...
  <div class="container">
    ...
    <div class="container">
      <div class="row"> 
        ...
        <div class="col-md-4 ">
          <div class="grid overlay">
            <figure> <img class="img-responsive" src="public/img/portfolio/folio01.jpg" alt="">
              <figcaption>
                <h5>Coco Cake</h5>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <p><img class="img-responsive" src="public/img/portfolio/folio01-preview.jpg" alt=""></p>
        ...
        <div class="col-md-4">
          <div class="grid overlay">
            <figure> <img class="img-responsive" src="public/img/portfolio/folio02.jpg" alt="">
              <figcaption>
                <h5>Green Tea</h5>
                <a data-toggle="modal" href="#myModal" class="btn btn-default">More Details</a> </figcaption>
              <!-- /figcaption --> 
        ...
        <div class="col-md-4">
          <div class="grid overlay">
            <figure> <img class="img-responsive" src="public/img/portfolio/folio03.jpg" alt="">
              <figcaption>
                <h5>Cappuccino</h5>
                <a data-toggle="modal" href="#myModal" class="btn btn-default">More Details</a> </figcaption>
              <!-- /figcaption --> 
      ...
      <div class="row">
        <div class="col-md-4 ">
          <div class="grid overlay">
            <figure> <img class="img-responsive" src="public/img/portfolio/folio04.jpg" alt="">
              <figcaption>
                <h5>Green Tea</h5>
                <a data-toggle="modal" href="#myModal" class="btn btn-default">More Details</a> </figcaption>
              <!-- /figcaption --> 
        ...
        <div class="col-md-4">
          <div class="grid overlay">
            <figure> <img class="img-responsive" src="public/img/portfolio/folio05.jpg" alt="">
              <figcaption>
                <h5>Cookies</h5>
                <a data-toggle="modal" href="#myModal" class="btn btn-default">More Details</a> </figcaption>
              <!-- /figcaption --> 
        ...
        <div class="col-md-4">
          <div class="grid overlay">
            <figure> <img class="img-responsive" src="public/img/portfolio/folio06.jpg" alt="">
              <figcaption>
                <h5>Cake</h5>
                <a data-toggle="modal" href="#myModal" class="btn btn-default">More Details</a> </figcaption>
              <!-- /figcaption --> 
...
<div id="team" name="team">
  <div class="container">
    <div class="row centered">
      ...
      <div class="col-lg-3 centered"> <img class="img img-circle" src="public/img/team/team01.jpg" height="120px" width="120px" alt="">
      ...
      <div class="col-lg-3 centered"> <img class="img img-circle" src="public/img/team/team02.jpg" height="120px" width="120px" alt="">
        <h4><b>Kristean</b></h4>
        <p>Consectetuer eu nam. Saepe legendos vulputate eu quo, id mea comprehensam signifer.</p>
        <a href="#"><i class="fa fa-twitter"></i></a> <a href="#"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-linkedin"></i></a> </div>
      <div class="col-lg-3 centered"> <img class="img img-circle" src="public/img/team/team03.jpg" height="120px" width="120px" alt="">
        <h4><b>Angilica</b></h4>
        <p>Consectetuer eu nam. Saepe legendos vulputate eu quo, id mea comprehensam signifer.</p>
        <a href="#"><i class="fa fa-twitter"></i></a> <a href="#"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-linkedin"></i></a> </div>
      <div class="col-lg-3 centered"> <img class="img img-circle" src="public/img/team/team04.jpg" height="120px" width="120px" alt="">
        <h4><b>Shannon</b></h4>
        <p>Consectetuer eu nam. Saepe legendos vulputate eu quo, id mea comprehensam signifer.</p>
        <a href="#"><i class="fa fa-twitter"></i></a> <a href="#"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-linkedin"></i></a> </div>
...
<div id="footerwrap">
  <div class="container">
    <div class="row">
      <div class="col-md-8"> <span class="copyright">&copy; 2019 Company Name. <a href="https://webthemez.com/free-bootstrap-templates/" target="_blank" title="Free Bootstrap Themes">Free Bootstrap Themes</a> by WebThemez.com</span> </div>
      <div class="col-md-4">
...
<script>
            window.watsonAssistantChatOptions = {
                integrationID: "acd5a561-1a0a-43f3-abf1-e07d84197af9", // The ID of this integration.
                region: "eu-gb", // The region your integration is hosted in.
                serviceInstanceID: "4e74c40e-c70d-4819-a49a-d8324a0e3296", // The ID of your service instance.
